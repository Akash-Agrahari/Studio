...
function Details() {
  return (
    <>
      <div className='w-full px-6 pt-10 lg:px-10 lg:pt-20 flex flex-col gap-12 lg:gap-5 2xl:gap-8 text-[#222222]  min-h-screen'>
        
        {/* Section 1: Who We Are */}
        <div className="flex flex-col lg:flex-row items-start">
          <h1 className="w-full lg:w-[20%] text-lg fut-medium  2xl:text-[1.7rem] mb-2 lg:mb-0">
            Who We Are
          </h1>
          <h1 className="w-full lg:w-[20%] text-lg fut-medium  2xl:text-[1.7rem] mb-4 lg:mb-0">
            EN
          </h1>
          <h1 className="w-full lg:w-[50%] text-lg fut-medium  2xl:text-[1.7rem] leading-7 2xl:leading-8">
        ...
        <div className="flex flex-col lg:flex-row items-start">
          ...
          <h1 className="w-full lg:w-[50%] text-lg fut-medium  2xl:text-[1.7rem] flex flex-col gap-5 leading-7 2xl:leading-8">
        ...
        <div className="flex flex-col lg:flex-row items-start">
          ...
          <div className="hidden lg:block w-[20%]"></div>
          <h1 className="w-full lg:w-[50%] text-lg fut-medium  2xl:text-[1.7rem] underline">
