...
function Fotter() {
  return (
    <div className='bg-black overflow-hidden relative -z-2 w-full h-[50vh] md:h-[80vh] grid grid-cols-12 grid-rows-6 py-4 md:py-10 border-t border-[#333]'>
      ...
      <h1 className='text-white text-[clamp(.8rem,4vw,3rem)] 2xl:text-[3rem] lg:text-xl font-medium top-4 left-4 md:top-10 md:left-10 absolute'>
        Let's talk.
      </h1>
      ...
      <p className='row-start-2 col-start-2 md:col-start-3 lg:col-start-3 2xl:text-[2rem] col-span-3 text-[#aaaaaa] text-[clamp(.5rem,3vw,2rem)] lg:text-lg font-light self-center'>
        Independent
      </p>
      ...
      <div className='row-start-2 col-span-4 md:col-span-2 lg:col-span-2 items-center text-center col-start-9 md:col-start-9 lg:col-start-9 flex flex-col justify-center'>
        <h1 className='text-white text-[clamp(.5rem,3vw,2rem)] 2xl:text-[2rem] lg:text-xl font-medium whitespace-nowrap'>Start A Conversation</h1>
        <p className='text-[#aaaaaa] text-[clamp(.4rem,2.5vw,1rem)]  2xl:text-[1.5rem] font-light'>contact@skadoosh.com</p>
      </div>
      ...
      <div className='row-start-4 lg:row-start-5 mt-1 md:mt-2 col-start-8 lg:col-start-7 col-span-6 text-center pt-4 md:pt-10 flex flex-col justify-center'>
        <p className='text-[#aaaaaa] 2xl:text-[2rem] text-[clamp(.5rem,2.5vw,2rem)] lg:text-lg font-light'>Designing Obsession</p>
      </div>
      ...
      <div className='row-start-5 lg:row-start-6 mt-2 md:mt-5 col-start-1 lg:col-start-2 flex flex-col items-center justify-center col-span-5 lg:col-span-3'>
        <h1 className='text-white 2xl:text-[2rem] text-[clamp(.5rem,3vw,2rem)] lg:text-lg font-medium text-center leading-tight'>From India To Worldwide</h1>
        <p className='text-[#aaaaaa] 2xl:text-[1.5rem] text-[clamp(.4rem,2.5vw,1rem)] lg:text-sm font-light mt-1'>26°27′00″N 80°19′55″E</p>
      </div>
