...
function Skadoosh() {
    ...
    return (
        <>
            <div ref={scrollRef} className='w-full h-[300vh] relative bg-orange-500' >
                ...
                <div className='flex w-full h-screen  sticky top-0 gap-96 items-center overflow-hidden' >
                    ...
                    <div></div>
                    <motion.h1 style={{ x }} className=' font-["Futura std"] select-none text-[#ffffff] text-[25rem] font-black' >SKADOOOOH</motion.h1>
                </div>
